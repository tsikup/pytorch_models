...
class HookNet(BaseModel):
    ...
    Args:
        ...
        hook_indices: dict for context and details branch with list or tuple of two integers for hooking indices
    ...
    def __init__(
        ...
        hook_indices: Dict = {"context": [0, 2], "details": [1, 0]},
        depth: int = 4,
        n_convs: int = 2,
        n_filters: int = 16,
        kernel_size: int = 3,
        ...
        self._hook_indices = {
            "context": {
                (depth - 1) - hook_indices["context"][0]: hook_indices["context"][1] - 1
            },
            "details": {
                (depth - 1) - hook_indices["details"][0]: hook_indices["details"][1] - 1
            },
        }
        ...
        # mid conv
        self.details_mid_conv = ConvBlock(
            in_channels=n_filters * 2 ** (depth - 1),
            n_convs=n_convs,
            n_filters=n_filters * 2 * (depth + 1),
            kernel_size=kernel_size,
