...
Huang, H., Lin, L., Tong, R., Hu, H., Zhang, Q., Iwamoto, Y., Han, X., Chen, Y.W. and Wu, J., 2020, May. Unet 3+: A
full-scale connected unet for medical image segmentation. In ICASSP 2020-2020 IEEE International Conference on
Acoustics, Speech and Signal Processing (ICASSP) (pp. 1055-1059). IEEE.
"""
# -*- coding: utf-8 -*-
import numpy as np
import torch
...
from ...segmentation.unet.layers import unetConv2
...
class UNet3Plus(BaseModel):
    def __init__(
        ...
        super(UNet3Plus, self).__init__(config)
...
class UNet3Plus_DeepSup(BaseModel):
    def __init__(
        self,
        config,
        n_channels=3,
        ...
        super(UNet3Plus_DeepSup, self).__init__(config)
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
        self.feature_scale = feature_scale
...
class UNet3Plus_DeepSup_CGM(BaseModel):
    def __init__(
        self,
        config,
        n_channels=3,
        ...
        super(UNet3Plus_DeepSup_CGM, self).__init__(config)
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
        self.feature_scale = feature_scale
