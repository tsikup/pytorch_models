...
Zhou, Z., Siddiquee, M.M.R., Tajbakhsh, N. and Liang, J., 2019. Unet++: Redesigning skip connections to exploit
multiscale features in image segmentation. IEEE transactions on medical imaging, 39(6), pp.1856-1867.

Zhou, Z., Rahman Siddiquee, M.M., Tajbakhsh, N. and Liang, J., 2018. Unet++: A nested u-net architecture for medical
image segmentation. In Deep learning in medical image analysis and multimodal learning for clinical decision support
...
class UNet2Plus(BaseModel):
    def __init__(
        ...
        super(UNet2Plus, self).__init__(config)
